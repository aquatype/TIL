...
## 플렉스 컨테이너
아이템들을 담고 있는 공간 그 자체를 말한다.  
아래와 같이 컨테이너를 선언하며, 해당 엘리먼트의 다이렉트 칠드런 엘리먼트들은 모두 플렉스 아이템이 된다.
...
플렉스 컨테이너에도 축이 존재하지만 일반적인 x/y 축의 개념이 아니라 **메인 액시스**(main-axis, 주축)와 **크로스 액시스**(cross-axis, 교차축)의 개념으로 동작한다. 이는 메인 액시스 자체의 방향성이 유동적이기 때문이다.
...
```
  ...
  <img src='../images/flex-flex-direction.png' width='50%'>
...
```
  ...
  <img src='../images/flex-flex-wrap.png' width='50%'>
...
```
  ...
  <img src='../images/flex-justify-content.png' width='50%'>
...
```
  ...
  <img src='../images/flex-align-items.png' width='50%'>
...
```
  ...
  <img src='../images/flex-align-content.png' width='50%'>
