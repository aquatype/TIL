...
설레발 주도 개발이 당신의 프로젝트를 조지는 데에는 여러 가지 방법이 있다.
...
**5단계:** 마이크로서비스는 팀에 높은 수준의 데브옵스 기술을 요구하며, 따라서 적정한 정도의 투자가 있어야만 시스템과 팀을 확장하는 방법으로서 기능할 수 있다.
심각한 확장성 이슈를 겪기 전까지는 과투자인 것이다. 마이크로서비스는 추출되는 것이지 작성되는 것이 아니다. [이 글]도 참고하라.
